...
FServer.start = function (opts) {
	...
	// Check if its an Alloy app or not before assigning the value to pidObj
	if (isAlloy) {
		isAlloyOrClassic = true;
	} else {
		isAlloyOrClassic = false;
	}
