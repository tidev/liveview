 ...
 *  net.js
 *
 * Node.js style TCP Sockets for Titanium
 */
...
var net = (function() {
  ...
  require.register("tipm-buffer/index.js", function(exports, require, module) {
  ...
  require.register("tipm-string_decoder/index.js", function(exports, require, module) {
  ...
  require.register("tipm-stream/_stream_duplex.js", function(exports, require, module) {
  ...
  require.register("tipm-stream/_stream_passthrough.js", function(exports, require, module) {
  ...
  require.register("tipm-stream/_stream_readable.js", function(exports, require, module) {
    ...
    function chunkInvalid(state, chunk) {
      ...
      if (!Buffer.isBuffer(chunk) &&
        'string' !== typeof chunk && chunk !== null && chunk !== undefined && !state.objectMode && !er) {
    ...
    function maybeReadMore(stream, state) {
      ...
      else maybeReadMore_(stream, state);
    }
  ...
  require.register("tipm-stream/_stream_transform.js", function(exports, require, module) {
    ...
    Transform.prototype._write = function(chunk, encoding, cb) {
      ...
      if (!ts.transforming) {
        ...
        if (ts.needTransform || rs.needReadable || rs.length < rs.highWaterMark) this._read(rs.bufferSize);
      }
    };
  ...
  require.register("tipm-stream/_stream_writable.js", function(exports, require, module) {
    ...
    function validChunk(stream, state, chunk, cb) {
      var valid = true;
      if (!Buffer.isBuffer(chunk) &&
        'string' !== typeof chunk && chunk !== null && chunk !== undefined && !state.objectMode) {
    ...
    function onwrite(stream, er) {
      ...
      if (er) onwriteError(stream, state, sync, er, cb);
        ...
        if (!finishMaybe(stream, state)) {
          if (state.length === 0 && state.needDrain) onwriteDrain(stream, state);

          if (!state.bufferProcessing && state.buffer.length) clearBuffer(stream, state);
        }
  ...
  require.register("tipm-stream/index.js", function(exports, require, module) {
  ...
  require.register("tipm-events/index.js", function(exports, require, module) {

    /*!
     * events.js
     */

    // shim to avoid process undefined error
    ...
    EventEmitter.prototype.removeAllListeners = function(type) {
      ...
      if (!this._events.removeListener) {
        ...
        else if (this._events[type]) this._events[type] = undefined;
        return this;
      }
  ...
  require.register("net/index.js", function(exports, require, module) {

    /*!
     * net.js - node.js `net` library ported to Titanium
     */
    ...
    function guid() {
      return Math.floor((Math.random() * 1e25) + 1);
    }
    ...
    net.createServer = function() {
      ...
      var options = ('object' === typeof args[0]) ? args[0] : {};
      var callback = ('function' === typeof fn) ? fn : noop;
    ...
    net.createConnection = function() {
      ...
      var fn = args[args.length - 1];
      var options = {};
      var callback = (typeof fn === 'function') ? fn : noop;
    ...
    net.Server.prototype.listen = function() {
      ...
      options.port = args[0];
      options.host = ('string' === typeof args[1]) ? args[1] : "127.0.0.1";
      ...
      _proxy.host = options.host;
      _proxy.port = options.port;

      _proxy.accepted = function(e) {
        self._accept({
          id: guid(),
          socket: e.source,
          _proxy: e.inbound
    ...
    /**
     * [_accept description]
     * @param  {[type]} acceptInfo [description]
     * @return {[type]}            [description]
     */
    ...
    net.Server.prototype.address = noop;
    ...
    net.Socket = function(options) {
      ...
      if (options.bind) {
        this._proxy = options.bind;
        this._read(this._proxy);
        return;
      }

      if (options && !options.bind) {
        this._proxy = Ti.Network.Socket.createTCP({});
        this._proxy.host = options.host;
        this._proxy.port = options.port;
        this._proxy.connected = function(e) {
    ...
    net.Socket.prototype.__proto__ = Stream.prototype;
    ...
    net.Socket.prototype.connect = function() {
      ...
      self._proxy.host = options.host;
      self._proxy.port = options.port;
      self._proxy.connected = function(e) {
        self.emit('connect', e);
        Ti.Stream.pump(e.socket, function(e) {
          // TODO check if this is correct
          var _buffer = Buffer('' + e.buffer);
          self.emit('data', _buffer);
          if (self.ondata) self.ondata(_buffer.parent, _buffer.offset, _buffer.offset + _buffer.length);
        }, 1024, true);
      };
    ...
    /**
     * [setNoDelay description]
     * @param {[type]} noDelay [description]
     */

    net.Socket.prototype.setNoDelay = function(noDelay) {
      noDelay = (noDelay === undefined) ? true : noDelay;
      // TODO implement setNoDelay for Titanium
    };
    ...
    net.Socket.prototype.setKeepAlive = function(enable, delay) {
      ...
      this._keepAliveTimer = setInterval(function() { /*write keep alive to proxy*/
      }, delay);
    };
    ...
    net.Socket.prototype.write = function(data, encoding, fn) {
      ...
      var callback = fn || noop;
      _buffer = '' + data;
      this._bufferSize = this._bufferSize + _buffer.length;
      ...
      var _stream = Ti.Stream.write(self._proxy, bufferProxy,

      function(e) {
        if (e.bytesProcessed == -1) {
          self.bytesWritten = self.bytesWritten + bufferProxy.length;
          self._bufferSize = self._bufferSize - _buffer.length;
          self.emit('drain');
          callback();
        }
      });
    ...
    net.Socket.prototype.unref = noop;
    ...
    net.Socket.prototype.pause = noop;
    ...
    net.Socket.prototype.resume = noop;
    ...
    net.Socket.prototype.end = noop;

    // get connection state

    net.Socket.prototype.__defineGetter__('readyState', function() {
  ...
  require.alias("tipm-buffer/index.js", "net/deps/buffer/index.js");

  require.alias("tipm-stream/_stream_duplex.js", "net/deps/stream/_stream_duplex.js");
  require.alias("tipm-stream/_stream_passthrough.js", "net/deps/stream/_stream_passthrough.js");
  require.alias("tipm-stream/_stream_readable.js", "net/deps/stream/_stream_readable.js");
  require.alias("tipm-stream/_stream_transform.js", "net/deps/stream/_stream_transform.js");
  require.alias("tipm-stream/_stream_writable.js", "net/deps/stream/_stream_writable.js");
  require.alias("tipm-stream/index.js", "net/deps/stream/index.js");
  require.alias("tipm-util/index.js", "tipm-stream/deps/util/index.js");

  require.alias("tipm-events/index.js", "tipm-stream/deps/events/index.js");

  require.alias("tipm-string_decoder/index.js", "tipm-stream/deps/string_decoder/index.js");
  require.alias("tipm-buffer/index.js", "tipm-string_decoder/deps/buffer/index.js");

  require.alias("tipm-events/index.js", "net/deps/events/index.js");
